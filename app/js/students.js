        ...
        students.forEach(student => {
            ...
            card.innerHTML = `
                ...
                <div class="details">
                    ...
                    <div>Average: ${student.studentAverage * 100 / 40}%</div>
                </div>
                <div class="actions">
            ...
            deleteButton.addEventListener('click', () => removeStudent(student.studentId, studentFullName, card));

            const viewButton = card.querySelector('.view-button');
            viewButton.addEventListener('click', () => {
                window.location.href = `student?studentId=${encodeURIComponent(student.studentId)}`;
            });
